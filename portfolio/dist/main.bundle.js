...
var DownloadButtonComponent = /** @class */ (function () {
    ...
    DownloadButtonComponent.prototype.ngOnInit = function () {
        ...
        function animation() {
            ...
            tl.restart().play()
                .to(arrow, .35, { y: 2.5, ease: __WEBPACK_IMPORTED_MODULE_1_gsap__["CustomEase"].create('custom', 'M0,0,C0.042,0.14,0.374,1,0.5,1,0.64,1,0.964,0.11,1,0') }, 'click')
                .to(text, .3, { svgOrigin: '55% 35%', scale: .77, ease: __WEBPACK_IMPORTED_MODULE_1_gsap__["CustomEase"].create('custom', 'M0,0,C0.042,0.14,0.374,1,0.5,1,0.64,1,0.964,0.11,1,0') }, 'click+=.05')
                ...
                ease: __WEBPACK_IMPORTED_MODULE_1_gsap__["CustomEase"].create('custom', 'M0,0 C0.046,0.062 0.018,1 0.286,1 0.532,1 0.489,-0.206 0.734,-0.206 0.784,-0.206 0.832,-0.174 1,0')
            }, 'stretch+=.869')
